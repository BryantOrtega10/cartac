    ...
    <div class="row">
        <div class="col-12">
            <div class="nav-indicador">
                ...
                <span> &gt; </span>
                <a href="{{route('categorias.subcategoria.modificar',['categoria' => $categoria_sup->cat_id, 'id' => $categoria->cat_id])}}">Modificar</a>
            </div>
        </div>
    </div>
    <div>
        <form method="POST" action="{{ route('categorias.subcategoria.modificar',['categoria' => $categoria_sup->cat_id, 'id' => $categoria->cat_id]) }}" enctype="multipart/form-data">
            @csrf
